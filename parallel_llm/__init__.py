...
# Convenience function
def create_framework(api_key: str, **config_kwargs) -> ParallelLLM:
    """
    Create a ParallelLLM instance with optional configuration.
    ...
    Returns:
        Configured ParallelLLM instance
    """
    config = FrameworkConfig(**config_kwargs)
    return ParallelLLM(api_key=api_key, config=config)
